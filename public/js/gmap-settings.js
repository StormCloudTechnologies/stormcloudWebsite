...
function initialize() {
"use strict";
var myLatLng = new google.maps.LatLng(18.5624668,73.77266280000003);
...
var mapOptions = {
  ...
  var contentString = '<div style="max-width: 300px" id="content">'+
      '<div id="bodyContent">'+
	  '<h4>StormCloud Technologies Pvt Ltd.</h4>' +
      '<p style="font-size: 12px">Pune, Maharashtra, India - 411045</p>'+
      '</div>'+
      '</div>';
